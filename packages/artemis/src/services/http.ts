...
TODO Investigate why it seems that github events do nothing more than just log to console and die

Currently when a webhook is sent from github, it logs the event type but does not process any events
it's almost like the handlers just die part way through? Need to investigate further.
 ...
 */
const AllRoutes = Layer.mergeAll(wwwRoutes, HealthCheckRoute);
